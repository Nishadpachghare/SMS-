...
function FeatureServives() {
   return (
     <div className='flex flex-col justify-center items-center pt-10 pb-10 gap-5 h-[100vh]'>
      ...
      <div className='flex justify-center items-center gap-5 pt-10 font-semibold w-[100%]'>
         ...
         <div className="w-[325px] h-[450px] bg-white rounded-2xl shadow-md p-6 ">
             ...
             <img src="comunity.png" alt="icon"  className='w-10 h-10'/>
      ...
      <div className='flex justify-center items-center gap-2 pt-5 pr-13'>
         ...
         <div className='pt-17 pl-8'> <button type="button" className="p-2 rounded-full border-[2px] bg-[black] text-white text-base hover:bg-[white] hover:text-black  w-55" >Choose</button>
      </div>
       </div>
...
export default FeatureServives
